...
interface Status { state: "on" | "off" | "error"; tunnelRunning: boolean; portListening: boolean; systemProxyEnabled: boolean; proxyEnabled: boolean; autoConnect: boolean; lastError: string | null; }
